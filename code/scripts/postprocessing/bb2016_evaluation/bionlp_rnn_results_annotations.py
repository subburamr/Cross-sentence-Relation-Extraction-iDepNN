...
def run_evaluation(dataset_type, birnn_expt_name, feature_name, train_k_type, test_dataset_type):
    # labelled data
    ...
    # annotations
    annotation_results_path = '../../data/bionlp_2016/annotations/' + full_results_path
    ...
    predictions_file = results_dir + '*.decision'
...
if __name__ == '__main__':
    ...
    feature_name = 'postag_iob_suboptimal'
    train_k_type = 'train_k_le_3' # [train_k_0, train_k_le_1, train_k_le_2, train_k_le_3]
    test_dataset_types = ['k_0', 'k_le_1', 'k_le_2', 'k_le_3', 'k_le_8', 'k_all']

    for test_dataset_type in test_dataset_types:
        run_evaluation(dataset_type, birnn_expt_name, feature_name, train_k_type, test_dataset_type)

        annotation_results_path = '../../data/bionlp_2016/annotations/' + dataset_type + '/' + birnn_expt_name + '/'+ feature_name + '/' \
